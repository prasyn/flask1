...
def function_401(error):
    return render_template("page_401.html"), 401


@app.errorhandler(403)
def function_403(error):
    return render_template("page_403.html"), 403


@app.errorhandler(404)
def function_404(error):
    return render_template("page_404.html"), 404


@app.errorhandler(405)
def function_405(error):
    return render_template("page_405.html"), 405


@app.errorhandler(413)
def function_413(error):
...
def function_delete_image(image_uid):
...
def function_login():
    ...
    return redirect(url_for("function_root"))
...
def function_delete_user(id):
    if session.get("current_user", None) == "ADMIN":
        ...
        return redirect(url_for("function_admin"))
    else:
        return abort(401)


@app.route("/add_user", methods=["POST"])
def function_add_user():
